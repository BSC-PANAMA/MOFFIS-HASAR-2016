...
namespace MOFFIS
{
    ...
    {                
        ...
        public Array acctPers = Array.CreateInstance(typeof(string), 3, 0);
        		
        public GLInformation()
		{
    ...
    //        return acctPers(0, 0)(13);
    //    }
    //    //Public Function getFirstOpenDay() As String
    //    //getAcctPeriods()
    //    //Return acctPers(0, 0)(13)
    //    //End Function
       
    //    public void getAcctPeriods()
    //    {
    //        ptApp.app.GetAccountingPeriods(periodsPerYear, CurrentPeriod, acctPers.set[0][0] , acctPers(1, 0));
    //        //ptApp.app.GetAccountingPeriods(periodsPerYear, CurrentPeriod, dtFromDate, dtToDate);
    //    }
    ////Public Sub getAcctPeriods()
    ////    App.GetAccountingPeriods(periodsPerYear, CurrentPeriod, acctPers(0, 0), acctPers(1, 0))
    ////End Sub
    ...
    //    Return acctPers(0, 0)(13)
    //End Function
    //Public Function getLastOpenDay() As String
    //    getAcctPeriods()
    //    Return acctPers(1, 0)(periodsPerYear + 13)
    //End Function
    //Public Function getLastDayOfCurrPeriod()
    //    getAcctPeriods()
    //    Return acctPers(1, 0)(CurrentPeriod)
    //End Function
    //Public Sub getAcctPeriods()
    //    App.GetAccountingPeriods(periodsPerYear, CurrentPeriod, acctPers(0, 0), acctPers(1, 0))
    //End Sub
